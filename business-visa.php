                        ...
                        <div class="col-lg-12">
                           <div class="section-heading">
                              ...
                              <div class="text-box">
                                    ...
                                    <p>Come to take part in international business activities without being part of the Canadian
                                        labour market
                                        are visiting Canada temporarily to
                                        look for ways to grow your business
                                        invest
                                        advance your business relationships Business visitors usually stay in Canada for a few
                                        days or a few weeks, but are able to stay for up to 6 months.</p>
                                    ...
                                    <ul class="visa-detail-featured">
                                        <li class="clearfix">
                                            ...
                                            <div class="text">
                                                ...
                                                <p>you plan to stay for less than 6 months.</p>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                ...
                                                <p>you don’t plan to enter the Canadian labour market</p>
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                ...
                                                <p>your main place of business and source of income and profits is outside
                                                    Canada</p>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="visa-benefits-content">
                                        <div class="title">
                                            ...
                                            <p>Business visitors and business people are not the same. Business people come to
                                                do work in Canada under a free trade agreement. Learn more about business
                                                people.</p>
                                        </div>
                                        <div class="row">
                                            <div class="col-xl-7">
                                                <ul>
                                                    ...
                                                    <li>if you need an eTA, you must travel using the same passport you used in
                                                        your application
                                                    </li>
                                                    <li>letters of support from your parent company and a letter
                                                            of invitation from the Canadian host business or a Letter of
                                                        Recognition from the&nbsp; anada
                                                            Border Services Agency </li>
                                                    <li>other documents such as warranty or service agreements, or contracts, if
                                                        relevant to your visit
                                                    </li>
                                                    <li>24-hour contact details of your business host in Canada</li>
                                                    <li>proof that you have enough money for both your stay in Canada and your
                                                        return home
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="bottom-text">
                                        <p>If you’re a business visitor, you need either a visitor visa or an Electronic Travel
                                            Authorization (eTA) to come to Canada. You may also need to provide your
                                            fingerprints and photo (biometrics) if applying for a visitor visa.</p>
                                    </div>
