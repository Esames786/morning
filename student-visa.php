                  ...
                  <div class="inner-baner-container" style="background-image: url(assets/images/country/cover.jpg);">
                     <div class="container">
                        <div class="inner-banner-content">
                           <h1 class="page-title">Student Visa</h1>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="row">
                        <div class="col-lg-8">
                           <div class="section-heading">
                            ...
                            <p>They also provide insights about the profession’s most colorful personalities and
                                powerful institutions, as well as original commentary on breaking legal developments.The
                                resources managed in logistics can include physical items such as food, materials,
                                animals, equipment, and liquids.</p>
                            <ul class="visa-detail-featured">
                                <li class="clearfix">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>Canada is still accepting study permit applications, however, delays should be expected.</p>
                                    </div>
                                </li>
                                <li class="clearfix">
                                    <div class="icon">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>If you’re an international student who has a valid study permit or were approved for a study permit on or before March 18, 2020, you are exempt from the travel restrictions.</p>
                                    </div>
                                </li>
                                <li class="clearfix">
                                    <div class="icon">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>International students who remain in Canada can apply to renew their study permit, and can continue to study and work while their application renewal is being processed.</p>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="visa-benefits-content">
                                <div class="title">
                                    ...
                                    <p>Generally, you must apply for a study permit before you come to Canada. Some
                                        people can apply for a study permit from within Canada. In some cases, you can
                                        apply when you arrive in Canada at the port of entry. Make sure you understand
                                        which option is available to you.</p>
                                </div>
                                <div class="row">
                                    <div class="col-xl-7">
                                        <ul>
                                            <li>No courier fees or mail delivery time – we get your application instantly.</li>
                                            <li>Your applications may be processed more quickly.</li>
                                            <li>It helps you make sure your pplication is complete before you submit it.</li>
                                            <li>You can quickly submit more documents online (if we ask you to).</li>
                                            <li>You get updates on the status of your application directly in your online account.</li>
                                        </ul>
                                    </div>
                                    <div class="col-xl-5">
                            ...
                            <div class="bottom-text">
                                <p>Before you apply for a study permit, you need:
