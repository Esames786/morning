                        ...
                        <div class="col-lg-8">
                           <div class="section-heading">
                            ...
                            <p>Canada is still accepting work permit applications. The following foreign workers are now
                                allowed to cross the border into Canada by land or air:</p>
                            <ul class="visa-detail-featured">
                                <li class="clearfix">
                                    ...
                                    <div class="text">
                                        <h3>IEC participants</h3>

                                        <p>IEC participants who have not yet activated their work permits must have a
                                            valid job offer in order to enter</p>
                                    </div>
                                </li>
                                <li class="clearfix">
                                    <div class="icon">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>If you’re travelling by air, you need to follow all airline requirements and
                                            pass a health check conducted by airlines before you’re allowed to board
                                            your flight. Anyone who shows symptoms of COVID-19 will not be allowed to
                                            enter Canada by air.</p>
                                    </div>
                                </li>
                                <li class="clearfix">
                                    <div class="icon">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>When you arrive in Canada, they will assess your health before you leave the
                                            port of entry. You must have a plan to quarantine for 14 days when you
                                            arrive in Canada. This is mandatory, even if you have no symptoms. </p>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="visa-benefits-content">
                                <div class="title">
                                    ...
                                    <p>Working in Canada is an attractive option for many skilled foreign workers from
                                        all over the world. Each year, close to 200,000 foreign skilled workers come to
                                        work in Canada on Temporary Canadian Work Permits. There is no reason why this
                                        cannot be you too!</p>
                                </div>
                                <div class="row">
                                    <div class="col-xl-7">
                            ...
                            <div class="bottom-text">
                                <p>Only people who provide essential services, for example, truck drivers who regularly cross the border to maintain the flow of goods, are exempt from the quarantine requirements.</p>
                            </div>
